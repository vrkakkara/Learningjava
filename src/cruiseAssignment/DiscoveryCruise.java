...
public class DiscoveryCruise extends Cruise{
	...
	public double finalBill(int numberOfAdults, int numberOfChildren, boolean hasFood) {
		...
		double buffetKids=0;
		double adultFare=numberOfAdults*39.99;
		double childFare=numberOfChildren*9.99;
		if(hasFood) {
		...
		System.out.println("Discovery Cruise Adults @"+numberOfAdults+" : "+adultFare);
		System.out.println("Discovery Cruise Kids above age 5 @"+numberOfChildren+" : "+childFare);
