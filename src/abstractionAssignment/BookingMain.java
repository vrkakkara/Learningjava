...
public class BookingMain {
	...
	// Taking customer sign up details
		        ...
		        if(bookingChoice.equals("1")) {
		        	...
		        	booking=new DeluxeSuite(typeOfSuite, hasLunch, customerName, numberOfDays, numberOfAdults, numberOfChildren);
		        	...
		        	booking=new FamilySuite(typeOfSuite, hasLunch, customerName,numberOfDays,numberOfAdults, numberOfChildren);
		        ...
		        if(bookingChoice.equals("2")) {
		    		...
		    		if (cruiseNumber.equals("1")) {
		    			cruise=new ScenicCruise( wantsFood, customerName, numberOfAdults, bigChildren);
		    			
		    		}
		    		else if (cruiseNumber.equals("2")) {
                        cruise=new SunsetCruise( wantsFood, customerName, numberOfAdults, bigChildren);
		    			
		    		}
		    		else if (cruiseNumber.equals("3")) {
                        cruise=new DiscoveryCruise( wantsFood, customerName, numberOfAdults, bigChildren);
		    			
		    		}
		    		else if (cruiseNumber.equals("4")) {
                        cruise=new MysteryCruise( wantsFood, customerName, numberOfAdults, bigChildren);
