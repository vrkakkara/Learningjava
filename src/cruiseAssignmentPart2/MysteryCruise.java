...
public class MysteryCruise extends Cruise{
	...
	public double finalBill(int numberOfAdults, int numberOfChildren, boolean hasFood) {
		...
		double buffetKids=0;
		double adultFare=numberOfAdults*45.99;
		...
		System.out.println("Mystery Cruise Adults @"+numberOfAdults+" : "+adultFare);
		System.out.println("Mystery Cruise Kids above age 5 @"+numberOfChildren+" : "+childFare);
